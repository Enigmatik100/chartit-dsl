...
/**
 * This is the item provider adapter for a {@link chartitproject.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Condition_operator_feature",
								"_UI_Condition_type"),
						ChartitprojectPackage.Literals.CONDITION__OPERATOR, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ChartitprojectPackage.Literals.CONDITION__RIGHT_ELEMENT);
			childrenFeatures.add(ChartitprojectPackage.Literals.CONDITION__LEFT_ELEMENT);
		}
	...
	public String getText(Object object) {
		CompOperator labelValue = ((Condition) object).getOperator();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ChartitprojectPackage.Literals.CONDITION__RIGHT_ELEMENT,
				ChartitprojectFactory.eINSTANCE.createIntVariable()));

		newChildDescriptors.add(createChildParameter(ChartitprojectPackage.Literals.CONDITION__RIGHT_ELEMENT,
				ChartitprojectFactory.eINSTANCE.createStringVariable()));

		newChildDescriptors.add(createChildParameter(ChartitprojectPackage.Literals.CONDITION__RIGHT_ELEMENT,
				ChartitprojectFactory.eINSTANCE.createDoubleVariable()));

		newChildDescriptors.add(createChildParameter(ChartitprojectPackage.Literals.CONDITION__LEFT_ELEMENT,
				ChartitprojectFactory.eINSTANCE.createColumnRef()));
	}
