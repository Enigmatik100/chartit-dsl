...
/**
 * This is the item provider adapter for a {@link chartitproject.IntVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntVariableItemProvider extends ConstantItemProvider {
	/**
	...
	protected void addInitialValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IntVariable_initialValue_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IntVariable_initialValue_feature",
								"_UI_IntVariable_type"),
						ChartitprojectPackage.Literals.INT_VARIABLE__INITIAL_VALUE, true, false, false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_IntVariable_type") + " " + intVariable.getInitialValue();
	}
