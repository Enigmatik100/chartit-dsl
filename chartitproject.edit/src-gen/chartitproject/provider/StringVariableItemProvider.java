...
/**
 * This is the item provider adapter for a {@link chartitproject.StringVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringVariableItemProvider extends ConstantItemProvider {
	/**
	...
	protected void addInitialValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_StringVariable_initialValue_feature",
						"_UI_StringVariable_type"),
				ChartitprojectPackage.Literals.STRING_VARIABLE__INITIAL_VALUE, true, false, false,
	...
	public String getText(Object object) {
		String label = ((StringVariable) object).getInitialValue();
		return label == null || label.length() == 0 ? getString("_UI_StringVariable_type")
	...
	public void notifyChanged(Notification notification) {
		...
		case ChartitprojectPackage.STRING_VARIABLE__INITIAL_VALUE:
