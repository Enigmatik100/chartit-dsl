 ...
 * @generated
 */
public class ChartitprojectSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ChartitprojectPackage.CONSTANT: {
		...
		case ChartitprojectPackage.INT_VARIABLE: {
			...
			if (result == null)
				result = caseConstant(intVariable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ChartitprojectPackage.STRING_VARIABLE: {
			...
			if (result == null)
				result = caseConstant(stringVariable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ChartitprojectPackage.DOUBLE_VARIABLE: {
			DoubleVariable doubleVariable = (DoubleVariable) theEObject;
			T result = caseDoubleVariable(doubleVariable);
			if (result == null)
				result = caseConstant(doubleVariable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Double Variable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Double Variable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDoubleVariable(DoubleVariable object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Column Ref</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Column Ref</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
