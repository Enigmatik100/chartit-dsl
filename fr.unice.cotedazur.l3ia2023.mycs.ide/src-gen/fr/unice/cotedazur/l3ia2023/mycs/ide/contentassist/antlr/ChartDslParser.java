...
public class ChartDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ChartDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getChartAccess().getGroup_5_3(), "rule__Chart__Group_5_3__0");
			builder.put(grammarAccess.getChartAccess().getGroup_6(), "rule__Chart__Group_6__0");
			builder.put(grammarAccess.getChartAccess().getGroup_6_3(), "rule__Chart__Group_6_3__0");
			builder.put(grammarAccess.getChartAccess().getGroup_7(), "rule__Chart__Group_7__0");
			builder.put(grammarAccess.getChartAccess().getGroup_7_3(), "rule__Chart__Group_7_3__0");
			...
			builder.put(grammarAccess.getProgramAccess().getCsvFileAssignment_3(), "rule__Program__CsvFileAssignment_3");
			builder.put(grammarAccess.getProgramAccess().getChartAssignment_4(), "rule__Program__ChartAssignment_4");
			builder.put(grammarAccess.getProgramAccess().getChartAssignment_5(), "rule__Program__ChartAssignment_5");
			...
			builder.put(grammarAccess.getChartAccess().getXVariableAssignment_5_3_1(), "rule__Chart__XVariableAssignment_5_3_1");
			builder.put(grammarAccess.getChartAccess().getYVariableAssignment_6_2(), "rule__Chart__YVariableAssignment_6_2");
			builder.put(grammarAccess.getChartAccess().getYVariableAssignment_6_3_1(), "rule__Chart__YVariableAssignment_6_3_1");
			builder.put(grammarAccess.getChartAccess().getFilterAssignment_7_2(), "rule__Chart__FilterAssignment_7_2");
			builder.put(grammarAccess.getChartAccess().getFilterAssignment_7_3_1(), "rule__Chart__FilterAssignment_7_3_1");
			...
			builder.put(grammarAccess.getConditionAccess().getLeftElementAssignment_1(), "rule__Condition__LeftElementAssignment_1");
			builder.put(grammarAccess.getConditionAccess().getOperatorAssignment_2(), "rule__Condition__OperatorAssignment_2");
			builder.put(grammarAccess.getConditionAccess().getRightElementAssignment_3(), "rule__Condition__RightElementAssignment_3");
